...
from metamiejskie.bingo.models import Bingo, BingoEntry, BingoField
from metamiejskie.bingo.serializers import BingoSerializer, BingoChangeFieldSerializer
...
class BingoGetOrCreateAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        # bingo = Bingo.objects.filter(date=timezone.now()).first()
